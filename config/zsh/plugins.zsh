...
exists yq && zpm load @exec/yq,destination:completion,origin:'yq shell-completion zsh'
exists aqua && zpm load @exec/aqua,origin:'aqua completion zsh'
exists aqua-registry && zpm load @exec/aqua-registry,origin:'aqua-registry completion zsh'
